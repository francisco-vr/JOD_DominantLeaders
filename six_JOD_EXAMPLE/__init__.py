...
class Player(BasePlayer):
    ...
    leader_message = models.StringField( 
        choices=[['No destruyas dinero', 'No destruyas dinero'],
        ['Debes destruirle la mitad del dinero', 'Debes destruirle la mitad del dinero'],
        ['Podrías destruir la mitad del dinero', 'Podrías destruirle la mitad del dinero'],
        ...
        ['Sugiero destruir la mitad del dinero', 'Sugiero destruir la mitad del dinero'],
        ['Sugiero destruir todo el dinero', 'Sugiero destruir todo el dinero'],
        ['Podrías destruir todo el dinero', 'Podrías destruir todo el dinero']],
...
class beliefs(Page):
    ...
    def error_message(player, values):
        ...
        if total != 2:
            return 'El número total debe ser 2. No debes contarte a ti'
...
class leader_results_message(Page):
...
page_sequence = [ShuffleWaitPage2, protocolo, ejemplo_grupos, descripcion_pago, ejemplo_lider, ejemplo_miembrogrupo, instruccion_elicitation, sistema_pagos, elicitacion_prueba, tabla_prueba_norms, comprension1, feedback1,
 comprension2, feedback2, comprension3, feedback3, comprension4, feedback4, 
espera, norms_elicitation1, norms_elicitation2, espera, beliefs, espera, JOD_leader, espera, endownment_final_lideres, espera, leader_results_message,
followers_JOD, CalcularPromedios, endownment_final_seguidores, followers_JOD_results, norms_elicitation3, calculo_moda] 
