...
class Player(BasePlayer):
    ...
    agression = models.IntegerField(min=0, max=7000, initial=0)
...
page_sequence = [ShuffleWaitPage2, protocolo, ejemplo_grupos, descripcion_pago, ejemplo_lider, ejemplo_miembrogrupo, instruccion_elicitation, sistema_pagos, elicitacion_prueba, tabla_prueba_norms, comprension1, feedback1,
 comprension2, feedback2, comprension3, feedback3, comprension4, feedback4, espera, norms_elicitation1, norms_elicitation2, espera, beliefs, espera, JOD_leader, espera,
endownment_final_lideres, leader_results, followers_JOD, CalcularPromedios, endownment_final_seguidores, followers_JOD_results, norms_elicitation3, calculo_moda] 
